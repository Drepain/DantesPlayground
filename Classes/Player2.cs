...
public class Player2 : Sprite 
{
    ...
    public void Update()
    {
        ...
        if (!IsAttacking) { 
            if (InputManager.Direction2 != Vector2.Zero) {
                var dir = Vector2.Normalize(InputManager.Direction2);
        ...
        if (InputManager.ButtonClicked && InputManager.Direction2 == Vector2.Zero && AttackCooldown <= 0) IsAttacking = true;
    }
